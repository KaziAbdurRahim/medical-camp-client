...
const Home = () => {
  ...
  const subPackages = [
    ...
    },
    {
      name: "Silver",
      price: 10,
      features: ["Customizable style templates", "Basic image generation"],
    },
  ];
  // useEffect(()=>{
  ...
  return (
    <div className="">
      ...
      <div
        ...
        style={{
          backgroundImage:
            "url(https://static.vecteezy.com/system/resources/previews/018/882/560/non_2x/healthcare-and-medical-service-doctor-banner-medical-health-social-media-cover-design-realistic-hospital-webinar-template-free-vector.jpg)",
        }}
      >
        <div className="hero-overlay"></div>
        <div className="hero-content text-center">
          <div className="max-w-md">
            <h1 className="mb-5 text-5xl font-bold text-white">Best Camps</h1>
            <p className="mb-2 text-start text-white opacity-90">
              Seach your favorite camps
            </p>
            <div className="join">
              <div>
      ...
      <div className="my-28 container mx-auto">
        <h1 className="font-bold text-2xl pb-2 text-center">
          camps by Category
        </h1>
        ...
        <div role="tablist" className="tabs tabs-lift container">
          ...
          >
            <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 2xl:grid-cols-3 gap-6">
              {meals.length > 0 ? (
                meals
                  .filter((meal) => meal.category === "3days")
          ...
          >
            <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 2xl:grid-cols-3 gap-6">
              {meals.length > 0 ? (
                meals
                  .filter((meal) => meal.category === "7days")
                  .map((meal) => <MealCard key={meal._id} meal={meal} />)
              ) : (
                <p className="text-center col-span-full text-gray-500">
                  No camps found.
          ...
          >
            <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 2xl:grid-cols-3 gap-6">
              {meals.length > 0 ? (
                meals
                  .filter((meal) => meal.category === "10days")
                  .map((meal) => <MealCard key={meal._id} meal={meal} />)
              ) : (
                <p className="text-center col-span-full text-gray-500">
                  No camps found.
      ...
      <div className="bg-base-200 p-6 rounded-lg mt-8 pb-20 pt-10 text-center">
        ...
        <p className="mb-4">
          Subscribe to our newsletter for the latest camps updates.
        </p>
